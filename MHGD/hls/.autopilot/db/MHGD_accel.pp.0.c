...
void MHGD_free_accel(int Nt, int Nr, int mu)
{
 ...
 VITIS_LOOP_188_1: for (i = 0; i < mu; i++)
  free(table_real[i]);
 VITIS_LOOP_190_2: for (i = 0; i < mu; i++)
  free(table_imag[i]);
 VITIS_LOOP_192_3: for (i = 0; i < Nt; i++)
  free(temp_real[i]);
 VITIS_LOOP_194_4: for (i = 0; i < Nt; i++)
  free(temp_imag[i]);
...
# 392 "MHGD_accel.c"
 ...
 {
  VITIS_LOOP_413_1: for (i = 0; i < Nr * Nr; i++)
  {
 ...
 else
 {
  ...
  VITIS_LOOP_435_2: for (i = 0; i < Nt; i++)
 ...
 VITIS_LOOP_466_3: for (k = 0; k < iter; k++)
 {
  ...
  VITIS_LOOP_475_4: for(int l=offset; l < Nt+offset; l++){
   v[i].real = v_tb[l].real;
   v[i].imag = v_tb[l].imag;
  }
  offset = offset + Nt;
...
void Hx_accel(int Nt, int Nr, int mu, float dqam, MyComplex* x, MyComplex* x_result)
{
 ...
 VITIS_LOOP_539_1: for (i = 0; i < Nt; i++)
 {
  Hx_table_id = (x[i].real / dqam + mu - 1) / 2;



  VITIS_LOOP_545_2: for (j = 0; j < Nr; j++)
  {
  ...
  VITIS_LOOP_553_3: for (j = 0; j < Nr; j++)
  {
   temp_imag[i][j] = table_imag[Hx_table_id][Nt * j + i];
  }
 }
# 571 "MHGD_accel.c"
 VITIS_LOOP_571_4: for (i = 0; i < Nt; i++)
 {
