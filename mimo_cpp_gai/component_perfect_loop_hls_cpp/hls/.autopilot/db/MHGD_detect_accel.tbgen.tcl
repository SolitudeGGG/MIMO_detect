...
set C_modelArgList {
	...
	{ x_hat int 64 regular {axi_slave 0}  }
	{ Nt int 32 regular  }
	{ Nr int 32 unused  }
	{ mu int 32 regular  }
	{ H int 64 unused {axi_slave 0}  }
	{ y int 64 unused {axi_slave 0}  }
	{ sigma2 float 32 unused  }
	{ mmse_init int 32 regular  }
	{ lr_approx int 32 unused  }
	{ iter int 32 regular  }
	{ v_tb int 64 unused {axi_slave 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "x_hat","offset": { "type": "dynamic","port_name": "x_hat","bundle": "control"},"direction": "READWRITE"},{"cName": "H","offset": { "type": "dynamic","port_name": "H","bundle": "control"}},{"cName": "y","offset": { "type": "dynamic","port_name": "y","bundle": "control"}},{"cName": "v_tb","offset": { "type": "dynamic","port_name": "v_tb","bundle": "control"}}]}]} , 
 	{ "Name" : "x_hat", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	...
 	{ "Name" : "H", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	...
 	{ "Name" : "v_tb", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} , 
...
set portList { 
	...
	{ Nt sc_in sc_lv 32 signal 2 } 
	{ Nr sc_in sc_lv 32 signal 3 } 
	{ mu sc_in sc_lv 32 signal 4 } 
	{ sigma2 sc_in sc_lv 32 signal 7 } 
	{ mmse_init sc_in sc_lv 32 signal 8 } 
	{ lr_approx sc_in sc_lv 32 signal 9 } 
	{ iter sc_in sc_lv 32 signal 10 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"x_hat","role":"data","value":"16"},{"name":"H","role":"data","value":"28"},{"name":"y","role":"data","value":"40"},{"name":"v_tb","role":"data","value":"52"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "6", "7"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1", "EstimateLatencyMax" : "17936",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_map_4_fu_124", "Port" : "gmem", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_map_4_fu_124", "Parent" : "0", "Child" : ["2", "3"],
		"CDFG" : "map_4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_map_4_fu_124.sdiv_96ns_1ns_96_100_1_U1", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_map_4_fu_124.sdiv_96ns_1ns_96_100_1_U2", "Parent" : "1"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_MHGD_detect_accel_Pipeline_VITIS_LOOP_489_3_fu_136", "Parent" : "0", "Child" : ["5"],
		"CDFG" : "MHGD_detect_accel_Pipeline_VITIS_LOOP_489_3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "5002", "EstimateLatencyMax" : "15002",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "Nt", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_489_3", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_state1", "FirstStateIter" : "", "FirstStateBlock" : "ap_ST_fsm_state1_blk", "LastState" : "ap_ST_fsm_state1", "LastStateIter" : "", "LastStateBlock" : "ap_ST_fsm_state1_blk", "QuitState" : "ap_ST_fsm_state1", "QuitStateIter" : "", "QuitStateBlock" : "ap_ST_fsm_state1_blk", "OneDepthLoop" : "1", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_MHGD_detect_accel_Pipeline_VITIS_LOOP_489_3_fu_136.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "17936"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "17937"}
]}
