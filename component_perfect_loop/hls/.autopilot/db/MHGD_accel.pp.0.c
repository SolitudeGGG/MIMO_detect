...
# 406 "MHGD_accel.c"
 ...
 VITIS_LOOP_480_3: for (k = 0; k < iter; k++)
 {
#pragma HLS PIPELINE II=1
 ...
 c_matmultiple(H, transA, r, transB, Nr, Nt, Nr, 1, temp_Nt);
  ...
  VITIS_LOOP_490_4: for(int l=offset; l < Nt+offset; l++){
...
void Hx_accel(int Nt, int Nr, int mu, float dqam, MyComplex* x, MyComplex* x_result)
{
 ...
 VITIS_LOOP_554_1: for (i = 0; i < Nt; i++)
 {
  Hx_table_id = (x[i].real / dqam + mu - 1) / 2;



  VITIS_LOOP_560_2: for (j = 0; j < Nr; j++)
  {
  ...
  VITIS_LOOP_568_3: for (j = 0; j < Nr; j++)
  {
   temp_imag[i][j] = table_imag[Hx_table_id][Nt * j + i];
  }
 }
# 586 "MHGD_accel.c"
 VITIS_LOOP_586_4: for (i = 0; i < Nt; i++)
 {
