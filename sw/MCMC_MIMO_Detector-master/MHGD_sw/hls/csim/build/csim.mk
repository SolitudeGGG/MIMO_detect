...
HLS_SOURCES = ../../../../main_sw.cpp ../../../../MHGD_accel_sw.cpp
...
$(ObjDir)/main_sw.o: ../../../../main_sw.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../main_sw.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main_sw.d

$(ObjDir)/MHGD_accel_sw.o: ../../../../MHGD_accel_sw.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../MHGD_accel_sw.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/MHGD_accel_sw.d
