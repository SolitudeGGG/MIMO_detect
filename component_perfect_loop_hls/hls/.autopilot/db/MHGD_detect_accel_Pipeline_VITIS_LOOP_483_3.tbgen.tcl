set moduleName MHGD_detect_accel_Pipeline_VITIS_LOOP_483_3
set isTopModule 0
...
set cdfgNum 3
set C_modelName {MHGD_detect_accel_Pipeline_VITIS_LOOP_483_3}
set C_modelType { int 1 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ iter int 32 regular  }
	{ bitcast_ln524 int 31 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "iter", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bitcast_ln524", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bitcast_ln524 sc_in sc_lv 31 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bitcast_ln524", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "bitcast_ln524", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10003", "Max" : "30003"}
	, {"Name" : "Interval", "Min" : "10003", "Max" : "30003"}
]}
...
set Spec2ImplPortList { 
	...
	bitcast_ln524 { ap_none {  { bitcast_ln524 in_data 0 31 } } }
