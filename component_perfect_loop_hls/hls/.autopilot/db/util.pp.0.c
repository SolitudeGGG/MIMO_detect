...
# 1 "/tools/Xilinx/Vitis/2024.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 1 3 4
# 30 "/tools/Xilinx/Vitis/2024.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/tools/Xilinx/Vitis/2024.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
...
# 1 "/tools/Xilinx/Vitis/2024.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3 4
# 90 "/tools/Xilinx/Vitis/2024.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef int wchar_t;
...
unsigned int lcg_rand() {
 ...
 lcg_seed = (1664525 * lcg_seed + 1013904223) % 0x7fffffff;;
...
{
 int i;
 VITIS_LOOP_35_1: for (i = 0; i < n * n; i++)
 {
...
{
 int i;
 VITIS_LOOP_53_1: for (i = 0; i < row * col; i++)
 {
...
{
 int i, j;
 VITIS_LOOP_101_1: for (i = 0; i < row; i++)
 {
  VITIS_LOOP_103_2: for (j = 0; j < col; j++)
  {
   A[i * col + j].real = 0.0;
   A[i * col + j].imag = 0.0;
  }
...
void MulMatrix(const MyComplex* A, const MyComplex* B, MyComplex* C, int row, int AB_rc, int col)
{
 int i, j, k;
 MyComplex sum, tmp;
 VITIS_LOOP_117_1: for (i = 0; i < row; i++)
 {
  VITIS_LOOP_119_2: for (j = 0; j < col; j++)
  {

   sum.real = 0.0;
   sum.imag = 0.0;
   VITIS_LOOP_124_3: for (k = 0; k < AB_rc; k++)
   {
...
{
# 147 "util.c"
 MyComplex _L[row * col];
 MyComplex _U[row * col];
 MyComplex _L_Inverse[row * col];
 MyComplex _U_Inverse[row * col];
...
#pragma HLS PIPELINE II=1
 VITIS_LOOP_166_1: for (i = 0; i < row; i++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 L[i * col + i].real = 1.0;
 ...
 VITIS_LOOP_173_2: for (j = 0; j < col; j++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 U[j] = A[j];
 }
 VITIS_LOOP_179_3: for (i = 1; i < col; i++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 ...
 VITIS_LOOP_186_4: for (k = 1; k < row; k++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 VITIS_LOOP_190_5: for (j = k; j < col; j++)
  {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 s.imag = 0.0;
   s.real = 0.0;
   VITIS_LOOP_196_6: for (t = 0; t < k; t++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 s = complex_add(s, complex_multiply(L[k * col + t], U[t * col + j]));
  ...
  VITIS_LOOP_203_7: for (i = k; i < col; i++)
  {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 s.imag = 0.0;
   s.real = 0.0;
   VITIS_LOOP_209_8: for (t = 0; t < k; t++)
   {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 ...
 VITIS_LOOP_219_9: for (i = 0; i < row; i++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 ...
 VITIS_LOOP_226_10: for (j = 0; j < col; j++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 VITIS_LOOP_230_11: for (i = j + 1; i < row; i++)
  {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 s.imag = 0.0;
   s.real = 0.0;
   VITIS_LOOP_236_12: for (k = j; k < i; k++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 ...
 di.real = 1.0;
 di.imag = 0.0;
 VITIS_LOOP_248_13: for (i = 0; i < col; i++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
 ...
 VITIS_LOOP_255_14: for (j = 0; j < col; j++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 VITIS_LOOP_259_15: for (i = j - 1; i >= 0; i--)
  {
#pragma HLS PIPELINE II=1
 s.imag = 0.0;
   s.real = 0.0;
   VITIS_LOOP_264_16: for (k = i + 1; k <= j; k++)
   {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS UNROLL
...
void my_complex_add(const int n, const MyComplex a[], const MyComplex b[], MyComplex r[]) {
 VITIS_LOOP_281_1: for (int i = 0; i < n; i++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
...
void my_complex_sub(const int n, const MyComplex a[], const MyComplex b[], MyComplex r[]) {
 VITIS_LOOP_290_1: for (int i = 0; i < n; i++) {
...
void my_complex_copy(const int N, const MyComplex* X, const int incX, MyComplex* Y, const int incY) {
 VITIS_LOOP_307_1: for (int i = 0, j = 0; i < N; i++, j++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
...
void my_complex_scal(const int N, const float alpha, MyComplex* X, const int incX) {
 VITIS_LOOP_316_1: for (int i = 0; i < N; i++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
 X[i * incX].real *= alpha;
  X[i * incX].imag *= alpha;
 }
...
void c_matmultiple(MyComplex* matA, int transA, MyComplex* matB, int transB, int ma, int na, int mb, int nb, MyComplex* res) {
 ...
 VITIS_LOOP_345_1: for (int i = 0; i < m; i++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
#pragma HLS PIPELINE II=1
 VITIS_LOOP_348_2: for (int j = 0; j < n; j++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
 MyComplex sum = { 0.0f, 0.0f };
   MyComplex temp = { 0.0f, 0.0f };
   VITIS_LOOP_352_3: for (int l = 0; l < k; l++) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
...
void read_gaussian_data(const char* filename, MyComplex* array, int n, int offset) {
 ...
 VITIS_LOOP_404_1: for (i = 0; i < offset; i++) {
 ...
 VITIS_LOOP_416_2: for (i = 0; i < n; i++) {
  if (fscanf(f, "Real: %f, Imaginary: %f\n", &temp_real, &temp_imag) != 2) {
...
void generateUniformRandoms_int(int Nt, int* x_init, int mu) {
 ...
 double upper_bound = pow(2, mu);


 VITIS_LOOP_438_1: for (int i = 0; i < Nt; ++i) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min

 double rand_val = ((double)lcg_rand() / 0x7fffffff) * upper_bound;
...
void generateUniformRandoms_float(int Nt, float p_uni[9]) {
 VITIS_LOOP_451_1: for (int i = 0; i < Nt; ++i) {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
 p_uni[i] = lcg_rand_1();
 }
}
...
int argmin(float* array, int n)
{
 ...
 VITIS_LOOP_462_1: for (i = 1; i < n; i++)
 {
  if (minval > array[i])
  {
   minval = array[i];
...
int unequal_times(int* array1, int* array2, int n)
{
 ...
 VITIS_LOOP_477_1: for (i = 0; i < n; i++)
 {
...
{
 int i;
 VITIS_LOOP_489_1: for (i = 0; i < Nt; i++)
 {
#pragma HLS LOOP_TRIPCOUNT max=Nt_max min=Nt_min
